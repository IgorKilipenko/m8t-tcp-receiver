...
class WiFiManager {
  public:
	...
	// WiFiEventId_t onStationConnected(WifiEventHandler);
	// WiFiEventId_t onStationDisconnected(WiFiEvent_t event);
	// WiFiEventId_t onApConnected(WiFiEvent_t event);
  ...
  private:
	...
	WiFiEventId_t _onWiFiEvent(WifiEventHandler callback, system_event_id_t systemEventId);
