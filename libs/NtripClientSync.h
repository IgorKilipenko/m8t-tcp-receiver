...
class NtripClientSync {
  public:
	//const static size_t BUFFER_LENGTH;
  ...
  private:
	...
	void buildConnStr(char* connStr, const char *host, uint16_t port, const char *user, const char *pass, const char *mountPoint, const char *nmea = nullptr);
	bool requestNtrip();
};
